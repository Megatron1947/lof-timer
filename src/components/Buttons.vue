<template>
    <div class="mt-18 flex gap-4">
        <!-- 重置 -->
        <div class="tooltip tooltip-info" data-tip="重置">
        ...
        <!-- 暂停 -->
        <div class="tooltip tooltip-info" data-tip="暂停" v-if="isTimerRunning">
            <button
        ...
        <!-- 开始 -->
        <div class="tooltip tooltip-info" data-tip="开始" v-else>
            <button
                class="btn btn-ghost btn-circle w-18 h-18"
        ...
        <!-- 设置 -->
        <div class="tooltip tooltip-info" data-tip="设置">
