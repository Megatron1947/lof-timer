    ...
    <div class="absolute top-0 left-0 right-0 h-16 group z-30">
        <div
            ...
            <div class="navbar-start">
                <!-- 重置 -->
                <div class="tooltip tooltip-info tooltip-bottom" data-tip="重置" v-if="compact">
                <button
                ...
                <!-- 开始/暂停 -->
                <div class="tooltip tooltip-info tooltip-bottom" :data-tip="isTimerRunning ? '暂停' : '开始'" v-if="compact">
                    <button
                        class="btn btn-ghost btn-circle"
                ...
                <!-- 快进 -->
                <div class="tooltip tooltip-info tooltip-bottom" data-tip="快进" v-if="isTimerRunning && devMode">
                    <button
                        class="btn btn-ghost btn-circle"
            ...
            <div class="navbar-end">
                <!-- 切换模式 -->
                <div class="tooltip tooltip-info tooltip-bottom" data-tip="切换模式">
                ...
                <!-- 最小化 -->
                <div class="tooltip tooltip-info tooltip-bottom" data-tip="最小化">
                ...
                <!-- 关闭 -->
                <div class="tooltip tooltip-info tooltip-bottom" data-tip="关闭">
